...
public class GridHexXZ<TGridObject> {
    ...
    {
        return
            new Vector3(pos.x, 0, 0) * cellSize +
            new Vector3(0, 0, pos.y) * cellSize * HEX_VERTICAL_OFFSET_MULTIPLIER +
            ((Mathf.Abs(pos.y) % 2) == 1 ? new Vector3(1, 0, 0) * cellSize * .5f : Vector3.zero) +
            originPosition;
    }
    ...
    public void GetXZ(Vector3 worldPosition, out int x, out int z) {
        ...
        Vector3Int roughXZ = new(roughX, 0, roughZ);
